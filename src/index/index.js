...
btnContent1.click(() => {
    ...
    import ( /* webpackChunkName: "page1/[request]" */ '../../assets/images/page-1.jpg').then(content1Img => {
...
btnContent2.click(() => {
    //this import could be a normal js file import, loading a full graph o dependencies
    import ( /* webpackChunkName: "page2/[request]" */ '../../assets/images/page-2.jpg').then(content2Img => {
...
btnContent3.click(() => {
    //this import could be a normal js file import, loading a full graph o dependencies
    import ( /* webpackChunkName: "page3/[request]" */ '../../assets/images/page-3.png').then(content3Img => {
